...
# Import-time snapshot preserves the long-standing ``EXECUTIONS_FILE``
# monkeypatch/embedding escape hatch while normal calls follow the active
# profile ContextVar.  Multiplexed gateways switch HERMES_HOME per request and
# per scheduler tick after modules have already been imported.
...
def _current_executions_file() -> Path:
    """Return the explicit compatibility override or active profile ledger."""
